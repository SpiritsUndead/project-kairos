...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BUTTERFREE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_TOXIC_PARASITES, ABILITY_TINTED_LENS },
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_SANDSLASH_ALOLA] =
    {
        ...
        .formSpeciesIdTable = sSandslashFormSpeciesIdTable,
        .formChangeTable = sSandslashAlolanFormChangeTable,
    },
    ...
    {    //todo bst changes
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_SandslashAlolanMega,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 1,
        .frontAnimFrames = sAnims_SandslashAlolanMega,
        .frontAnimId = ANIM_V_JUMPS_H_JUMPS,
        .backPic = gMonBackPic_SandslashAlolanMega,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_V_SHAKE_H_SLIDE,
        .palette = gMonPalette_SandslashAlolanMega,
        .shinyPalette = gMonShinyPalette_SandslashAlolanMega,
        .iconSprite = gMonIcon_SandslashAlolanMega,
        .iconPalIndex = 2,
        FOOTPRINT(Sandslash)
        .isAlolanForm = TRUE,
        .levelUpLearnset = sSandslashAlolaLevelUpLearnset,
...
#define ALAKAZAM_SP_DEF (P_UPDATED_STATS >= GEN_6 ? 95 : 85)
    ...
    [SPECIES_ALAKAZAM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_HUMILIATE, ABILITY_INNER_FOCUS, ABILITY_MAGIC_GUARD },
        .bodyColor = BODY_COLOR_BROWN,
...
#define GOLEM_ATTACK (P_UPDATED_STATS >= GEN_6 ? 120 : 110)
    ...
    [SPECIES_RAPIDASH_MEGA] =
    {
        ...
        .iconSprite = gMonIcon_RapidashMega,
        .iconPalIndex = 0,
        FOOTPRINT(Rapidash)
        .levelUpLearnset = sRapidashLevelUpLearnset,
        .teachableLearnset = sRapidashTeachableLearnset,
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_KOFFING_GALARIAN] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "you a chance to observe, through its thin\n"
            "skin, the toxic gases swirling inside. It\n"
            "will explode if you try to take its hat."),
        .pokemonScale = 369,
        .pokemonOffset = -1,
        .trainerScale = 256,
        .trainerOffset = 0,
        ...
        .shinyPalette = gMonShinyPalette_WeezingGalar,//todo
        ...
        .eggMoveLearnset = sKoffingEggMoveLearnset,
        .formSpeciesIdTable = sKoffingFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_WEEZING_GALAR},
