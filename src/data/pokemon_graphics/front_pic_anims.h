...
PLACEHOLDER_ANIM_SINGLE_FRAME(PalossandMega);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(HattereneMega);
...
//gen4 type swaps
PLACEHOLDER_ANIM_SINGLE_FRAME(Pipling);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pineplup);
PLACEHOLDER_ANIM_SINGLE_FRAME(Empoliage);
PLACEHOLDER_ANIM_SINGLE_FRAME(Turtwick);
PLACEHOLDER_ANIM_SINGLE_FRAME(Hearthle);
PLACEHOLDER_ANIM_SINGLE_FRAME(Forgeterra);
PLACEHOLDER_ANIM_SINGLE_FRAME(Chimshor);
PLACEHOLDER_ANIM_SINGLE_FRAME(Monchurno);
PLACEHOLDER_ANIM_SINGLE_FRAME(Inundape);
...
#endif //P_FAMILY_PECHARUNT
SINGLE_ANIMATION(Pipling);
SINGLE_ANIMATION(Pineplup);
SINGLE_ANIMATION(Empoliage);
SINGLE_ANIMATION(Turtwick);
SINGLE_ANIMATION(Hearthle);
SINGLE_ANIMATION(Forgeterra);
SINGLE_ANIMATION(Chimshor);
SINGLE_ANIMATION(Monchurno);
SINGLE_ANIMATION(Inundape);
