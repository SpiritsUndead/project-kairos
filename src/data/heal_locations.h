static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_HOTBROOK_FLATS - 1] = {MAP_GROUP(HOTBROOK_FLATS), MAP_NUM(HOTBROOK_FLATS), 3, 35},
    [HEAL_LOCATION_WHIMLEAF_TOWN - 1] = {MAP_GROUP(WHIMLEAF_TOWN), MAP_NUM(WHIMLEAF_TOWN), 11, 11},
    [HEAL_LOCATION_BITTERBREEZE_CITY - 1] = {MAP_GROUP(BITTERBREEZE_CITY), MAP_NUM(BITTERBREEZE_CITY), 18, 27},
    [HEAL_LOCATION_DAWNGEM_TOWN - 1] = {MAP_GROUP(DAWNGEM_TOWN), MAP_NUM(DAWNGEM_TOWN), 4, 9},
    [HEAL_LOCATION_SUNREND_BASIN - 1] = {MAP_GROUP(SUNREND_BASIN), MAP_NUM(SUNREND_BASIN), 32, 20},
    [HEAL_LOCATION_LUSHLEAF_VILLAGE - 1] = {MAP_GROUP(LUSHLEAF_VILLAGE), MAP_NUM(LUSHLEAF_VILLAGE), 27, 26},
    [HEAL_LOCATION_RUSTRUSH_CAPE - 1] = {MAP_GROUP(RUSTRUSH_CAPE), MAP_NUM(RUSTRUSH_CAPE), 9, 56},
    [HEAL_LOCATION_SEASTONE_HARBOR - 1] = {MAP_GROUP(SEASTONE_HARBOR), MAP_NUM(SEASTONE_HARBOR), 10, 10},
    [HEAL_LOCATION_ASHRASH_ISLAND - 1] = {MAP_GROUP(ASHRASH_ISLAND), MAP_NUM(ASHRASH_ISLAND), 10, 10},
};
