...
//#endif
    ...
    //HOENN_TO_NATIONAL(PIPLING),
    //HOENN_TO_NATIONAL(PINEPLUP),
    //HOENN_TO_NATIONAL(EMPOLIAGE),
    HOENN_TO_NATIONAL(TURTWICK),
    HOENN_TO_NATIONAL(HEARTHLE),
    HOENN_TO_NATIONAL(FORGETERRA),
    //HOENN_TO_NATIONAL(CHIMSHOR),
    //HOENN_TO_NATIONAL(MONCHURNO),
    //HOENN_TO_NATIONAL(INUNDAPE),
