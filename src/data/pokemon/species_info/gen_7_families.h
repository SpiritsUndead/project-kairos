...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_PALOSSAND] =
    {
        ...
        .formSpeciesIdTable = sPalossandFormSpeciesIdTable,
        .formChangeTable = sPalossandFormChangeTable,
    },
    ...
    {    //bst todo
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_PalossandMega,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_PalossandMega,
        .frontAnimId = ANIM_GLOW_BLACK,
        .backPic = gMonBackPic_PalossandMega,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        .palette = gMonPalette_PalossandMega,
        .shinyPalette = gMonShinyPalette_PalossandMega,
        .iconSprite = gMonIcon_PalossandMega,
        .iconPalIndex = 0,
        FOOTPRINT(Palossand)
        .levelUpLearnset = sPalossandLevelUpLearnset,
        .teachableLearnset = sPalossandTeachableLearnset,
