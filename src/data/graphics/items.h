...
const u32 gItemIcon_Skeledirgite[] = INCBIN_U32("graphics/items/icons/skeledirgite.4bpp.lz");
const u32 gItemIconPalette_Skeledirgite[] = INCBIN_U32("graphics/items/icon_palettes/skeledirgite.gbapal.lz");
...
const u32 gItemIcon_Sandslashite[] = INCBIN_U32("graphics/items/icons/sandslashite.4bpp.lz");
const u32 gItemIconPalette_Sandslashite[] = INCBIN_U32("graphics/items/icon_palettes/sandslashite.gbapal.lz");

const u32 gItemIcon_Palossite[] = INCBIN_U32("graphics/items/icons/palossite.4bpp.lz");
const u32 gItemIconPalette_Palossite[] = INCBIN_U32("graphics/items/icon_palettes/palossite.gbapal.lz");

const u32 gItemIcon_Corvite[] = INCBIN_U32("graphics/items/icons/corvite.4bpp.lz");
const u32 gItemIconPalette_Corvite[] = INCBIN_U32("graphics/items/icon_palettes/corvite.gbapal.lz");

const u32 gItemIcon_Toxtricitite[] = INCBIN_U32("graphics/items/icons/toxtricitite.4bpp.lz");
const u32 gItemIconPalette_Toxtricitite[] = INCBIN_U32("graphics/items/icon_palettes/toxtricitite.gbapal.lz");
